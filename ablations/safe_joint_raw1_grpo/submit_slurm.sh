...
common_export="ALL,SAFE_GRPO_BASE_MODEL=$SAFE_GRPO_BASE_MODEL,SAFE_GRPO_INPUT_ADAPTER=$SAFE_GRPO_INPUT_ADAPTER,SAFE_GRPO_INPUT_MARKER=$SAFE_GRPO_INPUT_MARKER,SAFE_GRPO_TRAIN_JSONL=$SAFE_GRPO_TRAIN_JSONL,SAFE_GRPO_DENOVO_DEV=$SAFE_GRPO_DENOVO_DEV,SAFE_GRPO_EDIT_DEV=$SAFE_GRPO_EDIT_DEV,SAFE_GRPO_DENOVO_FINAL=$SAFE_GRPO_DENOVO_FINAL,SAFE_GRPO_EDIT_FINAL=$SAFE_GRPO_EDIT_FINAL,SAFE_GRPO_OUTPUT_ROOT=$OUT,SAFE_GRPO_SUPPORT_REPORT=$SUPPORT"
...
audit=$(sbatch --parsable --account="$ACCOUNT" --job-name=safegrpo-support \
  ...
  --export="ALL,AUDIT_SCRIPT_DIR=$ROOT/audits/editing_reward_support,AUDIT_BASE_MODEL=$SAFE_GRPO_BASE_MODEL,AUDIT_ADAPTER_DIR=$SAFE_GRPO_INPUT_ADAPTER,AUDIT_TRAIN_JSONL=$SAFE_GRPO_TRAIN_JSONL,AUDIT_OUTPUT_ROOT=$OUT/support" \
